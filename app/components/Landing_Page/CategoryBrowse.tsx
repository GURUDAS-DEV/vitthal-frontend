...
export function CategoryBrowse() {
  return (
    <section id="categories" className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h2 className="text-2xl font-semibold tracking-tight text-zinc-900">Browse by Category</h2>
        <p className="mt-2 text-sm text-zinc-600 leading-relaxed">Explore supplier depth across core industrial categories</p>
      </div>
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {categories.map((category) => (
          <article
            key={category.title}
            className="group overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-sm hover:shadow-md transition-shadow"
          >
            ...
            <div className="space-y-3 p-5">
              ...
              <div className="flex gap-4 text-xs text-zinc-600 py-2 border-t border-zinc-100">
              ...
              <a
                ...
                className="inline-block mt-3 rounded-md bg-[#1d4ed8] px-4 py-2 text-sm font-medium text-white hover:bg-[#1e40af] transition-colors"
              >
